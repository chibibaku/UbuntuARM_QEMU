...
read username
echo -n "Please_input_VM_password(default 'password'):"
read password

echo "Update package lists..."
sudo apt update &> /dev/null
echo "Install Qemu..."
sudo apt install qemu-system-arm &> /dev/null
echo "Install cloud-image-utils..."
sudo apt install cloud-image-utils &> /dev/null
...
sed -e 's/user/$username/' cloud.new.tx &> /dev/nullt
